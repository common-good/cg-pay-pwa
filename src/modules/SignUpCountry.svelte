...
<!--      </form>-->
        ...
        <SlidingModal bind:showModal>
          <p>By opening an account, you are joining a partnership to create a Common Good Economy based on the Common Good Agreement. Please actually read it, so you know what you're agreeing to. It's short.</p>
        </SlidingModal>
