  ...
  <section class="page card" id="country-select">
    ...
    <div class='content'>
      ...
      <form id='demo-form'>
        ...
        <div class="input-container">
          <input 
            ...
            name="referredBy" 
            type="text" 
            placeholder="Where did you hear about Common Good?" 
            autocomplete="off" 
            autocapitalize="off" 
      ...
      <form action="?" method="POST">
        ...
        <small>By opening an account, you are joining a partnership to create a Common Good Economy based on the Common Good Agreement. Please actually read it, so you know what you're agreeing to. It's short.</small>
        <button type="button" onclick="{() => u.go('next-page')}">I Agree</button>
    </form>
