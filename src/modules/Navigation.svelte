<script>
  ...
  function switchAccount() { st.setMe(null); u.go('link-account') }
  ...
  item('Use Rear Camera', rearCamera, () => !u.onPage('scan') && $st.frontCamera, 'rear')
  item('Use Front Camera', frontCamera, () => !u.onPage('scan') && !$st.frontCamera, 'front')
